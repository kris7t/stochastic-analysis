...
In \cref{tab:evaluation:results} we present our preliminary performance results for our implemented block Kronecker decomposition based approaches. We performed several analysis for several models with relatively big state spaces. 